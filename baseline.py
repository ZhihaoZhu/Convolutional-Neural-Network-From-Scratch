...
def get_val_loss(val_X, val_y, val_loss, W1, b1, W2, b2, val_size, val_acc):
    # forward
    h = MLP_forward(val_X, W1, b1, layer=1, activation=Sigmoid())
    p = MLP_forward(h, W2, b2, layer=2, activation=Softmax())
...
kernel2 = random_kernel_init(output_channel1, output_channel2, 5)
...
M_W1, M_W2, M_b1, M_b2, M_kernel1, M_kernel2 = W1, W2, b1, b2, kernel1, kernel2
...
#         h = MLP_forward(flattened, W1, b1, layer=3, activation=Sigmoid())
#         p = MLP_forward(h, W2, b2, layer=4, activation=Softmax())
#
#         # calculate loss
#         loss, acc = compute_loss_and_acc(yb, p)
#         # print(loss)
...
#         # backward
#         delta1 = p - yb
#         delta2, grad_W2, grad_b2 = MLP_backwards(delta1, W2, b2, layer=4, activation_deriv=linear_deriv)
#         delta3, grad_W1, grad_b1 = MLP_backwards(delta2, W1, b1, layer=3, activation_deriv=sigmoid_deriv)
#
#         # Update the weight
#         '''
#             Without Momentum
